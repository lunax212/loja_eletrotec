<?php
    ...
    function fnAddProduto($nome, $foto, $codproduto, $quantidade) {
        $con = getConnection();
        $sql = "insert into produto (nome, foto, codproduto, quantidade) values (:pNome, :pFoto, :pCodproduto, :pQuantidade)";
    ...
    function fnUpdateProduto($id, $nome, $foto, $quantidade) {
        $con = getConnection();
                
        $sql = "update produto set nome = :pNome, foto = :pFoto, quantidade = :pQuantidade where id = :pID";
